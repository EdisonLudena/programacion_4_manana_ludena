  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Icon(
            _activo ? Icons.sports_soccer : Icons.warning_amber,
            size: 72,
          ...
          ElevatedButton.icon(
            ...
            label: Text(_activo ? 'Suspender jugador' : 'Habilitar jugador'),
          ...
          Opacity(
            ...
            child: Text(
              'Amonestaciones: $_reinicios / $_maxReinicios',
              style: TextStyle(
                fontSize: 13,
          ...
          TextButton(
            ...
            child: const Text('Limpiar amonestaciones'),
          ),
        ],
      ),
    );
