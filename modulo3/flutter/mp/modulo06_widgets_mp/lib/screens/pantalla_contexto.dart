  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Vestuario: ${esMovil ? "Móvil" : "Tablet"} · ${esRetrato ? "Táctico" : "Panorámico"}',
      ...
      body: ListView(
        ...
        children: [
          ...
          _Seccion(titulo: 'Esquema de Colores', items: []),
          Wrap(
          ...
          _Seccion(titulo: 'Estilos Tipográficos', items: []),
