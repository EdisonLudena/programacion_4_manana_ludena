...
class PantallaMetricas extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rendimiento de jugadores'),
        actions: [
          IconButton(
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              const Spacer(),
              Text('${metrica.conexiones} goles',
                  style: TextStyle(fontSize: 12, color: cs.onSurfaceVariant)),
            ]),
            const SizedBox(height: 10),
            _Barra('FTG', metrica.cpu, cpuCritica),
            const SizedBox(height: 4),
            _Barra('EST', metrica.ram, ramCritica),
            const SizedBox(height: 4),
            _Barra('DES', metrica.ssd, ramCritica),
          ],
        ),
      ),
    );
