...
fun main() {
    ...
    CatalogoProductos.agregarProducto("Monitor 24",  170.99,  9, 1)
    CatalogoProductos.agregarProducto("Logitech\"", 32.99,  6, 2)
    CatalogoProductos.agregarProducto("Castor pro",    29.99,  5, 3)
    ...
    println("\n=== Disponibles con 10% descuento con FOR ===")
